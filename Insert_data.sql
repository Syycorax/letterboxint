...
('Moonlight', 2016, 'Une chronique de la vie d\'un jeune homme noir qui grandit dans un quartier difficile de Miami.', 111, 'https://image.tmdb.org/t/p/original/93EpJeZUUIONsAhIxRvUMazEUoN.jpg'),
('Get Out', 2017, 'Un jeune homme afro-américain visite la famille de sa petite amie blanche pour le week-end, où ses inquiétudes concernant l\'accueil se transforment en une découverte terrifiante.', 104, 'https://image.tmdb.org/t/p/original/lR6C8MmfVSrAlFuAH4nZrRQIFe8.jpg'),
('The Irishman', 2019, 'Un tueur à gages âgé réfléchit à sa vie et en particulier au rôle qu\'il a joué dans la disparition d\'un dirigeant syndical.', 209, 'https://image.tmdb.org/t/p/original/iLLDiO4dbUfFEnRug8DuvFEl1NB.jpg'),
('In the Mood for Love', 2000, 'Deux voisins forment une forte liaison après avoir découvert que leurs conjoints ont une liaison.', 98, 'https://image.tmdb.org/t/p/original/iYypPT4bhqXZ3qkGcQvpr1Y1HEI.jpg'),
