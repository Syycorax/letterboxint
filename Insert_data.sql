...
('La La Land', 2016, 'Un pianiste de jazz et une actrice en herbe tombent amoureux tout en poursuivant leurs rêves à Los Angeles.', 128, 'https://image.tmdb.org/t/p/original/qJeU7KM4nT2C1WpOrwPcSDGFUWq.jpg'),
('Hereditary', 2018, 'Une famille commence à découvrir des secrets terrifiants sur leur généalogie après la mort de leur grand-mère recluse.', 127, 'https://image.tmdb.org/t/p/original/xU6kL4HVwbYVdfHMCqKDfYQhx2YJ.jpg'),
('Roma', 2018, 'Une année dans la vie d\'une femme de ménage travaillant pour une famille de la classe moyenne à Mexico dans les années 1970.', 135, 'https://image.tmdb.org/t/p/original/9rnl5RiVPBhusizSmUJwuSPj0MV.jpg'),
('The Favourite', 2018, 'Au début du XVIIIe siècle, l\'Angleterre est en guerre avec la France. La reine Anne, à la santé fragile, occupe le trône tandis que son amie Lady Sarah gouverne le pays à sa place.', 119, 'https://image.tmdb.org/t/p/original/eUjOkHauLz0e3vs4JT4vRX2Bz4I.jpg'),
('Inglourious Basterds', 2009, 'Dans la France occupée pendant la Seconde Guerre mondiale, un groupe de soldats juifs américains prévoit d\'assassiner des nazis.', 153, 'https://image.tmdb.org/t/p/original/7sfbEnaARXDDhXz9jpi4eeUU5nf.jpg'),
...
('The Prestige', 2006, 'Après un tragique accident, deux magiciens de scène s\'engagent dans une bataille pour créer l\'illusion ultime tout en sacrifiant tout ce qu\'ils ont.', 130, 'https://image.tmdb.org/t/p/original/bdN3gXuYK5ILQ6umUVzTTDhcRQZ.jpg'),
...
('Ladybird', 2017, 'Une lycéenne, qui se fait appeler \"Lady Bird\", navigue entre les relations tumultueuses avec sa mère et ses amis pendant sa dernière année.', 94, 'https://image.tmdb.org/t/p/original/kfst76DlCRN83QOZkj25pu3fqfm.jpg'),
('Sicario', 2015, 'Une idéaliste du FBI est recrutée par une force opérationnelle gouvernementale pour aider dans la guerre croissante contre la drogue à la frontière entre les États-Unis et le Mexique.', 121, 'https://image.tmdb.org/t/p/original/tw0lXhbNkQFT0JV0RqiLKBfpdBJ.jpg'),
('Enemy', 2013, 'Un homme cherche son exact sosie après l\'avoir repéré dans un film.', 91, 'https://image.tmdb.org/t/p/original/vf40tyDRKZsBmaLsYeopzfFLzLx.jpg'),
...
('Memories of Murder', 2003, 'Dans une petite ville rurale de Corée du Sud en 1986, des détectives locaux et un détective de Séoul traquent un tueur en série.', 131, 'https://image.tmdb.org/t/p/original/rxndHKwUeFgTHx0PuuhZS4dMtrB.jpg'),
('Snowpiercer', 2013, 'Dans un futur où une expérience ratée pour contrer le réchauffement climatique a tué toute vie sur terre sauf les passagers d\'un train qui perpétuellement fait le tour du globe.', 126, 'https://image.tmdb.org/t/p/original/nzccOvhrLGI0nvAknCEAk8bchD9.jpg'),
...
('The Departed', 2006, 'Une taupe dans la police de Boston essaie d\'identifier et de dénoncer un espion infiltré dans la police par un groupe criminel.', 151, 'https://image.tmdb.org/t/p/original/aqfeqtqnuCk2zCG7QxVkvm7kf1O.jpg'),
...
('Pan\'s Labyrinth', 2006, 'Au milieu de la guerre civile espagnole, une jeune fille découvre un labyrinthe mystérieux où elle rencontre un faune qui lui confie trois tâches.', 118, 'https://image.tmdb.org/t/p/original/s8C4whhKtDaJvMDcyiMvx3BIF5F.jpg'),
('The Devil\'s Backbone', 2001, 'Après la mort de son père, un jeune garçon est envoyé dans un orphelinat mystérieux pendant la guerre civile espagnole.', 106, 'https://image.tmdb.org/t/p/original/iP1z1aJzPnkP8FHg77TS7ukqoEZ.jpg'),
...
('The Piano', 1993, 'Une femme muette est envoyée en Nouvelle-Zélande avec sa jeune fille pour un mariage arrangé avec un agriculteur.', 121, 'https://image.tmdb.org/t/p/original/rx8RKXn8OtuS6lqloYsjyrGOUp4.jpg'),
...
('12 Years a Slave', 2013, 'Dans les années précédant la guerre civile, un homme noir libre est kidnappé et vendu dans l\'esclavage.', 134, 'https://image.tmdb.org/t/p/original/xdANQijuNrJaw1HA61rDccME4Tm.jpg'),
('Selma', 2014, 'Une chronique de la campagne de Martin Luther King pour garantir les droits de vote égaux par une marche épique de Selma à Montgomery, Alabama, en 1965.', 128, 'https://image.tmdb.org/t/p/original/2oz6Wy4mALLfxLy2mfWMcKJNcrx.jpg'),
